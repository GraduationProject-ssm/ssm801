...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1xRe2eHEsa?p=2)
...
|chengji\_uuid\_number|成绩编号 |varchar(200)|是|
|chengji\_name|成绩名称 |varchar(200)|是|
|chengji\_types|成绩类型 |int(11)|否|
|chengji\_content|成绩详情|text|是|
|chengji\_fenshu|成绩分数|int(11)|否|
|chengji\_dedao\_fenshu|所得分数|int(11)|否|
...
|id (主键)|主键|int(11)|否|
|xuesheng\_id|学生|int(11)|是|
|chuqinlv\_uuid\_number|出勤率编号 |varchar(200)|是|
|chuqinlv\_yue|月份 |varchar(200)|是|
|chuqinlv\_name|出勤率|varchar(200)|是|
|chuqinlv\_fenshu|出勤率分数|int(11)|否|
|chuqinlv\_content|出勤率详情|text|是|
|insert\_time|录入时间|timestamp|是|
|create\_time|创建时间|timestamp|是|
表4-3 分数记录表
...
|id (主键)|主键|int(11)|否|
|xuesheng\_id|学生|int(11)|是|
|fenshujilu\_types|记录类型 |int(11)|否|
|fenshujilu\_fenshu|记录分数|int(11)|否|
|fenshujilu\_content|记录详情|text|是|
...
|id (主键)|主键|int(11)|否|
|xuesheng\_id|学生|int(11)|是|
|jiangcheng\_uuid\_number|奖惩编号 |varchar(200)|是|
|jiangcheng\_name|奖惩名称 |varchar(200)|是|
|jiangcheng\_types|奖惩类型 |int(11)|否|
|jiangcheng\_erji\_types|二级类型 |int(11)|否|
|jiangcheng\_jibie\_types|奖惩级别 |int(11)|否|
|jiangcheng\_fenshu|奖惩分数|int(11)|否|
...
|xuesheng\_fenshu|分数|decimal(10,2)|是|
|create\_time|创建时间|timestamp|是|
